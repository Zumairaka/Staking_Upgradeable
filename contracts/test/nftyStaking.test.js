...
describe('NFTY Staking Contract', () => {
	let NFTY, nfty, Stake, stake, owner, addr1, addr2, decimals
	...
	beforeEach(async () => {
		...
		Stake = await ethers.getContractFactory('NFTYStaking')
		stake = await Stake.deploy(nfty.address)
